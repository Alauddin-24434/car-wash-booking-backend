...
router.put('/services/:id', authValidation('admin'),  validateRequest(zodServiceValidations.updateServiceZodValidationSchema),  serviceControllers.UpdateServiceById)

// delete service 
router.delete('/services/:id', authValidation('admin'),   serviceControllers.deletedServiceById)

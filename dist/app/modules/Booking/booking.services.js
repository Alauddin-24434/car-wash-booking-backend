...
const createBookingServicesIntoDB = (payload, token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const populatedBooking = yield (yield newBooking.populate("serviceId")).populate("slotId");
        // Destructure the populated fields
        const { _id, serviceId, slotId, vehicleType, vehicleBrand, vehicleModel, manufacturingYear, registrationPlate, createdAt, updatedAt, } = populatedBooking;
